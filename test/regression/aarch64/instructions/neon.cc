...
TEST_P(InstNeon, addv) {
  ...
  CHECK_NEON(2, uint32_t, {0xAAAAAAAA, 0, 0, 0});
  CHECK_NEON(3, uint32_t, {0xFFFFFFFF, 0, 0, 0});
}
...
TEST_P(InstNeon, cmgt) {
  ...
  CHECK_NEON(2, uint32_t, {0, 0, 0xFFFFFFFF, 0xFFFFFFFF});
}
